...
<script type="application/ecmascript" id="source">
//------------------------------------
...
var another_label = new suit.Label("This is just some more text placed after the Button above. This text is aligned to the right, one of the many things you can do with a Label. How cool is that? Underneath is the source code used for this demo.");
another_label.set_line_height(1.6);
another_label.set_align("right");

var hpacker = new suit.Packer("horizontal");
hpacker.set_spacing (18);
...
var scriptel = document.getElementById('source');
var thistext = scriptel.textContent || scriptel.innerText;
var sourceview = new suit.Label(thistext);
sourceview.layout.set_font("monospace", 14);
sourceview.set_line_height(1.2);
packer.add(sourceview);
